...
const featuresData: Feature[] = [
  {
    ...
    title: "FORMAÇÃO",
    paragraph:
      "Irá beneficiar de formação permanente e apoio constante. Fornecemos a estratégia, a metodologia, os planos de trabalho e o conhecimento necessários para que o seu negócio cresça e prospere.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Temos uma estrutura de apoio constituída por um coordenador nacional, coordenadores regionais, formadores e formação nas diferentes áreas de atividade, bem como equipas qualificadas e competentes nos departamentos de marketing, comunicação, informático, jurídico e administrativo.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
     "Temos protocolos e uma relação privilegiada com parceiros nas várias áreas de atuação de nível nacional, como fornecedores, pós-venda e garantias. Relação próxima com as principais instituições bancárias e financeiras que operam no nosso país."
  },
